...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2016 at 09:37 AM
...
INSERT INTO `master_data` (`id`, `imei`, `ip`, `created_at`, `updated_at`, `click`, `view`, `type_device`, `language`, `state`, `regional`, `loc`) VALUES
(1, '2132411232123213', '103.10.105.60', '2016-09-01', '2016-09-26', 'login', 'welcome', 'samsung', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892'),
(2, '2314321325132', '103.10.105.60', '2016-09-02', '2016-09-26', 'save', 'registration', 'samsung', 'ID', 'West Sumatera', 'Meda', '-6.5944,106.7892'),
(3, '2132411232123211', '103.10.105.60', '2016-09-03', '2016-09-26', 'login', 'welcome', 'samsung', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892'),
(4, '2314321325132', '103.10.105.60', '2016-09-05', '2016-09-26', 'save', 'registration', 'samsung', 'ID', 'West Kalimantan', 'Balikpapan', '-6.5944,106.7892'),
(5, '2314321325133', '103.10.105.60', '2016-09-01', '2016-09-26', 'close', 'registration', 'apple', 'ID', 'West Sumatera', 'Medan', '-6.5944,106.7892'),
(6, '2314321325134', '103.10.105.60', '2016-09-01', '2016-09-26', 'delete', 'shopping', 'apple', 'ID', 'West Sumatera', 'Medan', '-6.5944,106.7892'),
(7, '2314321325135', '103.10.105.60', '2016-09-02', '2016-09-27', 'login', 'welcome', 'apple', 'ID', 'West Sumatera', 'Medan', '-6.5944,106.7892'),
(8, '2314321325136', '103.10.105.60', '2016-09-03', '2016-09-26', 'save', 'shopping', 'apple', 'ID', 'North Sumatera', 'Padang', '-6.5944,106.7892'),
(9, '4356243624354236', '103.10.105.60', '2016-09-04', '2016-09-27', 'save', 'order', 'apple', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892'),
(10, '123232323', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892'),
(11, '123232323', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892'),
(12, '1232323111', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892'),
(13, '1232323111', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'West Java', 'Bogor', '-6.5944,106.7892');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_country` AS select year(`master_data`.`created_at`) AS `year`,`master_data`.`language` AS `country`,count(`master_data`.`language`) AS `count_country` from `master_data` group by `master_data`.`language`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_region` AS select year(`master_data`.`created_at`) AS `year`,`master_data`.`regional` AS `regional`,count(`master_data`.`regional`) AS `count_region` from `master_data` group by `master_data`.`regional`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_state` AS select year(`master_data`.`created_at`) AS `year`,`master_data`.`state` AS `regional`,count(`master_data`.`state`) AS `count_state` from `master_data` group by `master_data`.`state`;
