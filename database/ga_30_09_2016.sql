...
--
-- Host: localhost
-- Generation Time: Sep 30, 2016 at 02:14 PM
...
(6, '2314321325134', '2016-09-26', '2016-09-26', 'delete', 'shooping', 'asus', 'Indonesia', 'West Sumatera', 'Meda'),
(7, '2314321325135', '2016-09-26', '2016-09-27', 'login', 'welcome', 'lenovo', 'Indonesia', 'West Sumatera', 'Meda'),
(8, '2314321325136', '2016-09-26', '2016-09-26', 'save', 'shooping', 'apple', 'Indonesia', 'North Sumatera', 'Padang'),
(9, '4356243624354236', '2016-09-27', '2016-09-27', 'save', 'order', 'lenovo', 'Indoensia', 'West Java', 'Bogor');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_activity_by_type_device_per_day`  AS  select cast(`master_data`.`created_at` as date) AS `activity_day`,`master_data`.`type_device` AS `type_device`,count('created_at') AS `count_activity` from `master_data` group by `master_data`.`type_device`,cast(`master_data`.`created_at` as date) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_activity_by_type_device_per_month`  AS  select monthname(`master_data`.`created_at`) AS `activity_month`,`master_data`.`type_device` AS `type_device`,count('created_at') AS `count_activity` from `master_data` group by `master_data`.`type_device`,extract(month from `master_data`.`created_at`) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_by_click_per_day`  AS  select cast(`master_data`.`created_at` as date) AS `click_day`,`master_data`.`click` AS `click`,count('created_at') AS `count_click` from `master_data` group by `master_data`.`click`,cast(`master_data`.`created_at` as date) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_by_click_per_month`  AS  select monthname(`master_data`.`created_at`) AS `click_month`,`master_data`.`click` AS `click`,count('created_at') AS `count_click` from `master_data` group by `master_data`.`click`,monthname(`master_data`.`created_at`) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_by_click_per_year`  AS  select year(`master_data`.`created_at`) AS `click_year`,`master_data`.`click` AS `click`,count('created_at') AS `count_click` from `master_data` group by `master_data`.`click`,year(`master_data`.`created_at`) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_by_view_page_perday`  AS  select cast(`master_data`.`created_at` as date) AS `view_day`,`master_data`.`view` AS `view`,count('created_at') AS `count_view` from `master_data` group by `master_data`.`view`,cast(`master_data`.`created_at` as date) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_by_view_page_permonth`  AS  select monthname(`master_data`.`created_at`) AS `view_month`,`master_data`.`view` AS `view`,count('created_at') AS `count_view` from `master_data` group by `master_data`.`view`,monthname(`master_data`.`created_at`) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_by_view_page_peryear`  AS  select year(`master_data`.`created_at`) AS `view_year`,`master_data`.`view` AS `view`,count('created_at') AS `count_view` from `master_data` group by `master_data`.`view`,year(`master_data`.`created_at`) ;
