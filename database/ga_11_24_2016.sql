...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2016 at 03:41 PM
...
INSERT INTO `connectedby` (`id`, `created_at`, `updated_at`, `connected_by`, `latitude`, `longitude`, `user`) VALUES
(1, '2016-11-01', '2016-11-02', 'wifi', -6.58527, 106.79768, 'drikdoank@gmail.com'),
(2, '2016-11-03', '2016-11-04', 'cellular', -6.59606, 106.79276, 'indriyani.cs49@gmail.com'),
(3, '2016-11-01', '2016-11-03', 'wifi', -6.60852, 106.81034, 'drikdoank@gmail.com');
...
INSERT INTO `master_data` (`id`, `imei`, `ip`, `created_at`, `updated_at`, `click`, `view`, `type_device`, `language`, `state`, `regional`, `loc`, `user`) VALUES
(1, '2132411232123213', '103.10.105.60', '2016-09-01', '2016-09-26', 'login', 'welcome', 'samsung', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(2, '2314321325132', '103.10.105.60', '2016-09-02', '2016-09-26', 'save', 'registration', 'samsung', 'ID', 'Sumatera Barat', 'Medan', '-6.5944,106.7892', 'indriyani.cs49@gmail.com'),
(3, '2132411232123211', '103.10.105.60', '2016-09-03', '2016-09-26', 'login', 'welcome', 'samsung', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(4, '2314321325132', '103.10.105.60', '2016-09-05', '2016-09-26', 'save', 'registration', 'samsung', 'ID', 'Kalimantan Barat', 'Balikpapan', '-6.5944,106.7892', 'indriyani.cs49@gmail.com'),
(5, '2314321325133', '103.10.105.60', '2016-09-01', '2016-09-26', 'close', 'registration', 'apple', 'ID', 'Sumatera Barat', 'Medan', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(6, '2314321325134', '103.10.105.60', '2016-09-01', '2016-09-26', 'delete', 'shopping', 'apple', 'ID', 'Sumatera Barat', 'Medan', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(7, '2314321325135', '103.10.105.60', '2016-09-02', '2016-09-27', 'login', 'welcome', 'apple', 'ID', 'Sumatera Barat', 'Medan', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(8, '2314321325136', '103.10.105.60', '2016-09-03', '2016-09-26', 'save', 'shopping', 'apple', 'ID', 'Sumatera Utara', 'Padang', '-6.5944,106.7892', 'indriyani.cs49@gmail.com'),
(9, '4356243624354236', '103.10.105.60', '2016-09-04', '2016-09-27', 'save', 'order', 'apple', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(10, '123232323', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(11, '123232323', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'indriyani.cs49@gmail.com'),
(12, '1232323111', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(13, '1232323111', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'Jawa Barat', 'Bogor', '-6.5944,106.7892', 'drikdoank@gmail.com'),
(14, '1232323111', '103.10.105.60', '2016-11-22', '2016-11-22', 'save', 'registration', 'samsung', 'ID', 'Jawa barat', 'Bogor', '-6.5944,106.7892', 'indriyani.cs49@gmail.com');
...
(1, 'Hendrik', 'drikdoank@gmail.com', 'admin', '$2y$10$rFCavDebMnD4B3CAvG0ptuuj6PaBLUGjVoMXfBk3bj3W8RAHvVkZG', 'armbNGlRTpOSUZBIkt0JcQIvtfP2VWONzzPvZ2LVORw7PwBeXbWXUnz11BzC', '2016-09-17 03:02:01', '2016-11-22 07:41:06'),
...
(6, 'Indriyani', 'indriyani.cs49@gmail.com', 'partner', '$2y$10$Z/CL3nOYV5Q.FM0fSHFRtuqEcE/IDzH9eb7ItbSx9/9.tmzY8cJuS', 'QxeABYxNQmb5MmiTdEECUCUTBL7gKmrrfMlbOTSCeSJXIiSUP8TSpqikT18H', '2016-10-02 07:14:30', '2016-11-22 06:34:10');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_country_admin` AS select `master_data`.`language` AS `country`,count(`master_data`.`language`) AS `count_country` from `master_data` group by `master_data`.`language`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_region` AS select `master_data`.`user` AS `user`,`master_data`.`regional` AS `regional`,count(`master_data`.`regional`) AS `count_region` from `master_data` group by `master_data`.`regional`,`master_data`.`user`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_region_admin` AS select `master_data`.`regional` AS `regional`,count(`master_data`.`regional`) AS `count_region` from `master_data` group by `master_data`.`regional`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_state` AS select `master_data`.`user` AS `user`,`master_data`.`state` AS `regional`,count(`master_data`.`state`) AS `count_state` from `master_data` group by `master_data`.`state`,`master_data`.`user`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `map_state_admin` AS select `master_data`.`state` AS `regional`,count(`master_data`.`state`) AS `count_state` from `master_data` group by `master_data`.`state`;
